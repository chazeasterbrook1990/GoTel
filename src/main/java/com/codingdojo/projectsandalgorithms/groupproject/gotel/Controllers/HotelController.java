...
public class HotelController {
	...
	@GetMapping("/search")
	public String getHotelsByLocation(@RequestParam("q") String q, Model model,
	...
	public String getHotelDetails(@PathVariable("hotelId") String hotelId, @PathVariable("arrival") LocalDate arrival,
			@PathVariable("departure") LocalDate departure, Model model, HttpSession session)
